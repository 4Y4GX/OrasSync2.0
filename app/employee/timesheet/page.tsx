...
export default function TimesheetPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      const res = await fetch(`/api/employee/timesheet?from=${from}&to=${to}`, {
        cache: "no-store",
      });
  ...
  return (
    <div style={{ padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: 12, marginTop: 16, flexWrap: "wrap", alignItems: "end" }}>
          <div>
          ...
          <button onClick={fetchData} style={{ padding: "10px 14px", cursor: "pointer", fontWeight: 800 }}>
            Load
          </button>
        </div>
